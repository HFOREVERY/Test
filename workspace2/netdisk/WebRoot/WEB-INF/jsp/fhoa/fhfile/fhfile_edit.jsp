				...
				<div class="row">
					...
					<form action="fhfile/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">秘钥:</td>
								<td><input type="text" name="KEY" id="KEY" value="" maxlength="100" placeholder="这里输入秘钥" title="备注" style="width:98%;"/></td>
							</tr>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(document).ready(function(){
			...
			$("#uploadify1").uploadify({
				...
				'buttonText':	"files",
				'scriptData':	{'uploadPath':'/uploadFiles/uploadFile/','KEY':'11111'},//这个参数用于传递用户自己的参数，此时'method' 必须设置为GET, 后台可以用request.getParameter('name')获取名字的值
				'method'	:	"GET",
