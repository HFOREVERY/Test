...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		/*生成SQL脚本*/
		Freemarker.printFile("mysql_SQL_Template.ftl", root, "create_table_mysql/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		//Freemarker.printFile("oracle_SQL_Template.ftl", root, "create_table_oracle/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		//Freemarker.printFile("sqlserver_SQL_Template.ftl", root, "create_table_sqlserver/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		/*生成jsp页面*/
